// ==UserScript==
// @name          Web Telegram Dark
// @namespace     http://userstyles.org
// @description	  My mod by Nightly Telegram style
// @author        Haron Prime
// @homepage      https://userstyles.org/styles/132781
// @include       http://web.telegram.org/*
// @include       https://web.telegram.org/*
// @include       http://*.web.telegram.org/*
// @include       https://*.web.telegram.org/*
// @include       http://web.tlgrm.eu/*
// @include       https://web.tlgrm.eu/*
// @include       http://*.web.tlgrm.eu/*
// @include       https://*.web.tlgrm.eu/*
// @run-at        document-start
// @version       0.20180525212527
// ==/UserScript==
(function() {var css = [
	"body,",
	".modal-content {",
