...
// @description	  This is a fork of the WA-Web - Dark Skin to match my taste.
// @author        Prognoz
// @homepage      https://userstyles.org/styles/142914
// @include       http://web.whatsapp.com/*
// @include       https://web.whatsapp.com/*
// @include       http://*.web.whatsapp.com/*
// @include       https://*.web.whatsapp.com/*
// @run-at        document-start
// @version       0.20180906170424
// ==/UserScript==
(function() {var css = [
	"header.pane-header {",
	...
	"}",
	"",
	"html[dir=ltr] ._1i1U7.jZ4tp { background: transparent!important; }",
	"html[dir=rtl] ._1i1U7.jZ4tp { background: transparent!important; }",
	"html[dir=ltr] ._1i1U7._2DNgV { background: transparent!important; }",
	"html[dir=rtl] ._1i1U7._2DNgV { background: transparent!important; }",
	"",
	"html[dir] ._3kN0h,",
	".header-close svg,",
	".menu-icons-item,",
